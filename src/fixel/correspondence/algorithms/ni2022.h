...
#ifndef __fixel_correspondence_algorithms_ni2022_h__
#define __fixel_correspondence_algorithms_ni2022_h__


#include "fixel/correspondence/algorithms/combinatorial.h"


#define FIXELCORRESPONDENCE_NI2022_DEFAULT_ALPHA 0.5
#define FIXELCORRESPONDENCE_NI2022_DEFAULT_BETA 0.1
  ...
  namespace Fixel {
    namespace Correspondence {
      namespace Algorithms {
        ...
        class NI2022 : public Combinatorial<NI2022>
        { NOMEMALIGN
          public:

            NI2022 (const size_t max_origins_per_target,
                                                 ...
                                                 const Eigen::Array<int8_t, Eigen::Dynamic, 1>& origins_per_remapped_fixel)
            {
              ...
              for (uint32_t t_index = 0; t_index != rs.size(); ++t_index) {
                ...
                //                                   std::tan (std::acos (t[t_index].absdot(rs[t_index]))) :
                //                                   1.0f);
        ...
        float NI2022::a = FIXELCORRESPONDENCE_NI2022_DEFAULT_ALPHA;
        float NI2022::b = FIXELCORRESPONDENCE_NI2022_DEFAULT_BETA;
