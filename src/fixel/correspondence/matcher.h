    ...
    namespace Correspondence {
      ...
      { MEMALIGN(Matcher)
        ...
        public:
          ...
          Matcher (const std::string& source_file, const std::string& target_file, std::shared_ptr<Algorithms::Base>& algorithm);
          ...
          Image<uint32_t> get_template() const
          {
            return Image<uint32_t> (target_index);
          }
